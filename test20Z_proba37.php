...
<button style="font-size:30px; background-color: red; color:white;" type="submit" formmethod="post" form="form1" name="submit20Z"  id="myButton"  onclick="myFunction()" >Zakończ test</button><br>
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 1 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 1 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 1 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
...
if(isset($_POST['submit20Z']) and $ster == '0')
...
if(isset($_POST['submit20Z'])and  $ster =='1')
{
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 2 AND all_zadania.idZadania=test20Z.idZadania";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $tekstZ = $row['tekstZadania'];
echo"<p  class= 'zadania_y'> $tekstZ</p><br>";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 2 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 2 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 3 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 3 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 3 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 4 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 4 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 4 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 5 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 5 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 5 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 6 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 6 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 6 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 7 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 7 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 7 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 8 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 8 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 8 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 9 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 9 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 9 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 10 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 10 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 10 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 11 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 11 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 11 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 12 AND all_zadania.idZadania=test20Z.idZadania";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $tekstZ = $row['tekstZadania'];
echo"<p  class= 'zadania_y'> $tekstZ</p><br>";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 12 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 12 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 13 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 13 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 13 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 14 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 14 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 14 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 15 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 15 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 15 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 16 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 16 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 16 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 17 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 17 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 17 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 18 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 18 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 18 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 19 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 19 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 19 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 20 AND all_zadania.idZadania=test20Z.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20Z WHERE test20Z.idTestu20Z = 20 AND all_zadania.idZadania=test20Z.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20Z WHERE idTestu20Z = 20 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
