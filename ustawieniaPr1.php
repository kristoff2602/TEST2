...
if(isset($_POST['ddd'])){
for ($x = 0; $x <= 25; $x++) {
$sql = "UPDATE odpowiedzi_testu20 SET zad1odp = '0',zad2odp='0',zad3odp='0',zad4odp='0',zad5odp='0',zad6odp='0',zad7odp='0',zad8odp='0',zad9odp='0',zad9odp='0',zad10odp='0',zad11odp = '0',zad12odp = '0',zad13odp = '0',zad14odp = '0',zad15odp = '0',zad16odp = '0',zad17odp = '0',zad18odp = '0',zad19odp = '0',zad20odp = '0',sumaPunktow = '0' WHERE idUcznia = $x;";
if (mysqli_query($conn, $sql)) 
{
//echo"New record updated successfully";    
}
...
<form method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
<input type="submit" name='fff' style="font-size:50px; background-color: #aa80ff; color:white;" value="wyswietlWynikiDlaMnieAwaryjnie"/>
</form>
<?php
...
for ($j = 0; $j <= 19; $j++)    
{
if($tabOdp[$j]==$tabPrX[$j]){$sumaP=$sumaP+1;}
}    
$sql = "UPDATE odpowiedzi_testu20  SET sumaP = '$sumaP' WHERE id_odpowiedzi_testu20= '$k';";
if (mysqli_query($conn, $sql)) 
{
...
for ($m = 0; $m <= 19; $m++)    
{
if($tabOdp[$m]==$tabPrX[$m]){$sumaP=$sumaP+1;}
}    
$sql = "UPDATE odpowiedzi_testu20  SET sumaP = '$sumaP' WHERE id_odpowiedzi_testu20= $k;";
if (mysqli_query($conn, $sql)) 
{
...
<div id="demo">
<button type="button" onclick="myFunction()" id="butt" style="font-size:50px; background-color: blue; color:white;" >USTAW  PROBA1  </button>
</div>
<script>
function myFunction(){
  ...
  xhttp.onreadystatechange = function() {
   ...
   {  
    // document.getElementById("demo").innerHTML =
     // this.responseText;
    document.getElementById("butt").style.backgroundColor = "lightblue";
    }
  };
  //xhttp.open("GET", "ajax_info.txt", true);
  xhttp.open("GET", "ustawPr1.php", true);
  xhttp.send();
}	
