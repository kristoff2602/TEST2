...
<button style="font-size:30px; background-color: red; color:white;" type="submit" formmethod="post" form="form1" name="submit20X"  id="myButton"  onclick="myFunction()" >Zakończ test</button><br>
...
///odczyt sygnału sterującego $stat początek////
$sql = "SELECT statystyka FROM sterowanie WHERE idSterowania = 1 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
$stat = $row['statystyka'];
 $result -> free_result();
///odczyt sygnału sterującego $stat koniec////
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 1 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 1 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 1 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
...
if(isset($_POST['submit20X']) and $ster == '0')
...
///////początek punktacja za zad1/// 
$sql = "UPDATE odpowiedzi_testu20  SET pkt1zad = '$punkt' WHERE id_odpowiedzi_testu20=$mybea;";
if (mysqli_query($conn, $sql)) 
{
//echo"New record updated successfully";	
}
...
if(isset($_POST['submit20X']) and $ster == '1')	
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 2 AND all_zadania.idZadania=test20X.idZadania";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $tekstZ = $row['tekstZadania'];
echo"<p  class= 'zadania_y'> $tekstZ</p><br>";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 2 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 2 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 3 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 3 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 3 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 4 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 4 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 4 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 5 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 5 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 5 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 6 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 6 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 6 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 7 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 7 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 7 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 8 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 8 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 8 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 9 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 9 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 9 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 10 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 10 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 10 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 11 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 11 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 11 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 12 AND all_zadania.idZadania=test20X.idZadania";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $tekstZ = $row['tekstZadania'];
echo"<p  class= 'zadania_y'> $tekstZ</p><br>";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 12 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 12 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 13 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 13 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 13 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 14 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 14 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 14 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 15 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 15 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 15 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 16 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 16 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 16 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 17 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 17 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 17 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 18 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 18 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 18 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 19 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 19 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 19 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
...
$sql = "SELECT all_zadania.tekstZadania FROM all_zadania, test20X WHERE test20X.idTestu20X = 20 AND all_zadania.idZadania=test20X.idZadania";
...
$sql = "SELECT all_zadania.adresObrazka FROM all_zadania, test20X WHERE test20X.idTestu20X = 20 AND all_zadania.idZadania=test20X.idZadania"; 
...
////wczytanie prawidłowej odpowiedzi  zadania/////
 $sql = "SELECT odpPrawidlowa FROM test20X WHERE idTestu20X = 20 ;";
$result = $conn->query($sql);
 $row = $result->fetch_assoc();
 $odPraw = $row['odpPrawidlowa'];
 $result -> free_result();
